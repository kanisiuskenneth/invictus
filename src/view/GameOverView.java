...
public class GameOverView {
    ...
    public GameOverView(GameModel gameModel) {
        ...
        int score = Math.round(gameModel.player.getScore()*MainModel.score_multiplier);
        int coint = Math.round(gameModel.player.getScore()*MainModel.coin_multiplier/100);
        scorePanel.setLayout(new GridLayout(2, 2));
        JLabel scoreLabel = displayLabel("Score");
        JLabel scoreGet = displayLabel(": " +score);
        JLabel cointLabel = displayLabel("Coint");
        JLabel cointGet = displayLabel(":" +coint);
        scorePanel.add(scoreLabel);
        scorePanel.add(scoreGet);
        scorePanel.add(cointLabel);
